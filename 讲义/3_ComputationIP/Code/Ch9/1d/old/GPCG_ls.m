%  GPCG_ls
%
%  Gradient Projection / Conjugate Gradient algorithm to solve
%  nonnegatively constrained quadratic programming problem. Minimize
%    J(f) = 0.5 * f'*H*f - f'*b
%  subject to f >= 0.
%    H = K'*K + alpha*L  and  b = K'*d,
%  corresponding to J(f) = 0.5*||K*f-d||^2 + alpha/2 * f'*L*f.
  ...
  %  Negative Laplacian regularization operator.
